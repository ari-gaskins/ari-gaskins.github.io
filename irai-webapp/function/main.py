...
# NOTE: this function will be used for the 

IMG_WIDTH = 128
COLUMNS = [
    'J20', 'AV8B', 'Su24', 'Mig31', 'Su25', 'A400M', 'P3', 'Be200',
    'US2', 'Tu160', 'EF2000', 'C130', 'XB70', 'Mirage2000', 'B2', 'F4',
    'E2', 'F35', 'Rafale', 'U2', 'V22', 'B52', 'SR71', 'C17', 'JAS39', 
    'KC135', 'C2', 'Su57', 'F16', 'Su34', 'F14', 'MQ9', 'A10', 'YF23', 
    'C5', 'B1', 'Vulcan', 'F18', 'F15', 'Tu95', 'Tornado', 'J10', 'E7', 
    'AG600', 'F22', 'F117', 'RQ4'
]
